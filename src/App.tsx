...
const App = () => {
  ...
  useEffect(() => {
    queue()
      .defer(json, 'https://raw.githubusercontent.com/UNDP-Data/Energy-Hub-Dashboard/exclude-non-vertical-fund-projects/public/data/projects.json')
      .defer(json, 'https://raw.githubusercontent.com/UNDP-Data/Energy-Hub-Dashboard/exclude-non-vertical-fund-projects/public/data/indicatorMetaData.json')
      .defer(json, 'https://raw.githubusercontent.com/UNDP-Data/Energy-Hub-Dashboard/exclude-non-vertical-fund-projects/public/data/projectCoordinates.json')
