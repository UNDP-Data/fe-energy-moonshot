                  ...
                  onMouseEnter={(event) => {
                    if (regionOpacity) {
                      setHoverData({
                        ...
                        emissionsReduced: d.indicators.filter((ind) => ind.indicator === 'tree_equivalent')[0].value,
                        ...
                        grantAmountNonVerticalFund: d.indicators.filter((ind) => ind.indicator === 'grant_amount_nonvertical_fund')[0].value,
                        expensesNonVerticalFund: d.indicators.filter((ind) => ind.indicator === 'expenses_nonvertical_fund')[0].value,
                        coFinancingNonVerticalFund: d.indicators.filter((ind) => ind.indicator === 'cofinancing_nonvertical_fund')[0].value,
